...
int eXosip_hexa_generate_random(char *val, int val_size, char *str1, char *str2, char *str3) {
  osip_MD5_CTX Md5Ctx;
  char HA1[MD5HASHLEN];
...
int _eXosip_request_viamanager(struct eXosip_t *excontext, osip_message_t *sip, int family, int proto, struct sockaddr_storage *udp_local_bind, int ephemeral_port, int tcp_sock, char *host) {
...
int _eXosip_message_contactmanager(struct eXosip_t *excontext, osip_message_t *sip, int family, int proto, struct sockaddr_storage *udp_local_bind, int ephemeral_port, int sock, char *host) {
