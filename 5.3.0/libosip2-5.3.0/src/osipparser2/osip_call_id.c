...
int osip_call_id_init(osip_call_id_t **callid) {
...
/* returns -1 on error. */
int osip_call_id_parse(osip_call_id_t *callid, const char *hvalue) {
  const char *host;
  const char *end;
...
int osip_call_id_to_str(const osip_call_id_t *callid, char **dest) {
  *dest = NULL;
...
char *osip_call_id_get_number(osip_call_id_t *callid) {
  if (callid == NULL)
    return NULL;
...
char *osip_call_id_get_host(osip_call_id_t *callid) {
  if (callid == NULL)
    return NULL;
...
int osip_call_id_clone(const osip_call_id_t *callid, osip_call_id_t **dest) {
  int i;
  osip_call_id_t *ci;
